...
namespace Pobeda.DAL.Migrations
{
    ...
    [Migration("20240218160825_AddProductFilter")]
    partial class AddProductFilter
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pobeda.Domain.Entity.ProductFilter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProductProductFilter", b =>
                {
                    ...
                    b.ToTable("ProductProductFilter");
                });
            ...
            modelBuilder.Entity("ProductProductFilter", b =>
                {
                    b.HasOne("Pobeda.Domain.Entity.ProductFilter", null)
                        .WithMany()
